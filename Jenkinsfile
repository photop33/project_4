pipeline { 
	...
	stage ('Deploy HM'){
		    ...
		    bat	'helm install project-4 --dry-run  --debug --set image.repostitory=photop33/chart,image.tag=${BUILD_NUMBER} --set replicaCount=5 repository=photop33/Project3  type=LoadBalancer port=5500  name=lior project-helm'	
